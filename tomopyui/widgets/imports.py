...
class Import_APS32ID(ImportBase):
    """"""

    def __init__(self):
        super().__init__()
        self.raw_uploader = RawUploader_APS32ID(self)
        self.make_tab()
...
class RawUploader_APS32ID(UploaderBase):
    """ """

    def __init__(self, Import):
        super().__init__()  # look at UploaderBase __init__()
        self._init_widgets()
        self.projections = RawProjections_APS32ID()
        self.reset_metadata_to = Metadata_APS32ID
        self.Import = Import
        self.filechooser.title = "Import Raw h5 File"
        self.filetypes_to_look_for = [".hdf5", ".h5"]
        self.files_not_found_str = "Choose a directory with an h5 file."
