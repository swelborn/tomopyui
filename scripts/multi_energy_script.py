...
def shift_projections_init(low_e_prj, high_e_prj_shifted):
    ...
    low_e_prj.data = shrink_and_pad_projections(
            low_e_prj.data, low_e_prj.data, low_e_prj.energy_float, high_e_prj_shifted.energy_float, 5
        )
...
high_e.filepath = pathlib.Path(r"E:\Sam_Welborn\20220620_Welborn\Pristine\all_energies\08375.00eV\20220805-165339-alignment\20220805-1654-SIRT_3D\20220805-1709-alignment\20220805-1714-SIRT_CUDA\normalized_projections.hdf5")
...
hdffile = h5py.File(r"E:\Sam_Welborn\20220620_Welborn\Pristine\all_energies\all_energies.hdf5", "w")
